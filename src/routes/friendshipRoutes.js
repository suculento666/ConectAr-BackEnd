...
import { sendRequest, acceptRequest, removeRequest, getStatus, getFriends, getPending, getPeopleSuggestions } from '../controllers/friendshipController.js';
...
router.get('/suggestions',             getPeopleSuggestions); // GET    /api/friendships/suggestions  → posibles amistades
